...
public class Point {
  public static final Comparator<Point> BY_Y_AXIS = new Point.YAxisComparator();
  public static final Comparator<Point> BY_ANGLE = new Point.AngleComparator();
  ...
  public static void sortByPolarAngle(Point[] points) {
    ...
    Arrays.sort(points, 1, points.length, BY_ANGLE);
//		//selection sorting
//		for(int i = 1; i < points.length; i++){
//			int minIndex = i;
