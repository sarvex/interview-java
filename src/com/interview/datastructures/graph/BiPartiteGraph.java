...
public class BiPartiteGraph {
  ...
  private final Map<Integer, Integer> flag = new HashMap<Integer, Integer>();
  ...
  public static void main(String[] args) {
    ...
    for (Entry<Integer, Integer> item : biGraph.flag.entrySet()) {
  ...
  public boolean bipartite(Graph g) {
    ...
    for (Integer vertex : g.vertexs()) {
      if (flag.get(vertex) == null) {
        isSuccess = isSuccess && this.dfs(g, vertex, 1);
