...
public class SortBySwap {
  ...
  public static int sortBySelectInverseNumber(int[] array) {
    ...
    for (int i = 0; i < array.length; i++) {
      ...
      if (SortBySwap.isInverseNumber(array, min)) {
        SortBySwap.swap(array, min);
        num++;
      }
