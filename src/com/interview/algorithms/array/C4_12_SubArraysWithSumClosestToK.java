...
public class C4_12_SubArraysWithSumClosestToK {
  ...
  private static final HashMap<Integer, List<Integer>> subarrays = new HashMap<Integer, List<Integer>>();
  ...
  public static void split(int[] array, int K) {
    ...
    for (int i = 0; i < array.length; i++) {
      int current = array[i];
      Set<Map.Entry<Integer, List<Integer>>> entries = subarrays.entrySet();
      int size = entries.size();
      Map.Entry<Integer, List<Integer>>[] entriesArray = new Map.Entry[size];
      entriesArray = entries.toArray(entriesArray);
      for (int j = 0; j < size; j++) {
        Map.Entry<Integer, List<Integer>> entry = entriesArray[j];
    ...
    for (Map.Entry<Integer, List<Integer>> entry : C4_12_SubArraysWithSumClosestToK.subarrays.entrySet()) {
  ...
  public static void main(String[] args) {
    ...
    C4_12_SubArraysWithSumClosestToK.split(array, sum / 2);
